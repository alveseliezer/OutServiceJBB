...
class TipoServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_servico" do
    assert_difference('TipoServico.count') do
      post tipo_servicos_url, params: { tipo_servico: { references: @tipo_servico.references, tipo_Servico: @tipo_servico.tipo_Servico, valorTotal: @tipo_servico.valorTotal, valorUnitario: @tipo_servico.valorUnitario } }
    end
  ...
  test "should update tipo_servico" do
    patch tipo_servico_url(@tipo_servico), params: { tipo_servico: { references: @tipo_servico.references, tipo_Servico: @tipo_servico.tipo_Servico, valorTotal: @tipo_servico.valorTotal, valorUnitario: @tipo_servico.valorUnitario } }
